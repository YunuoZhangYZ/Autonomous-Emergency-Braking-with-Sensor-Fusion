...
% Example 1: Pasing scenarioFcnName
...
% and assign scenario object in model workspace
...
hws.assignin('scenario', scenario);
...
egoVehDyn = helperGetEgoVehicleDynamicsParams(scenario, egoActorID);
...
%% Bus Creation
% Create AEB buses
helperCreateAEBBusObjects("refPathSize", egoRefPath.numPoints);
